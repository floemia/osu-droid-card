...
interface IModApplicableToDifficultyWithSettings {
     ...
     */
    applyToDifficultyWithSettings(mode: Modes, difficulty: BeatmapDifficulty, mods: ModMap): void;
}
...
interface IModApplicableToHitObjectWithSettings {
     ...
     * @param mods The `Mod`s that are applied to the beatmap.
     */
    applyToHitObjectWithSettings(mode: Modes, hitObject: HitObject, mods: ModMap): void;
}
...
declare abstract class Mod {
     ...
     */
    isApplicableToDifficultyWithSettings(): this is this & IModApplicableToDifficultyWithSettings;
    /**
     ...
     */
    isApplicableToHitObjectWithSettings(): this is this & IModApplicableToHitObjectWithSettings;
    /**
...
declare class BeatmapProcessor {
     ...
     */
    postProcess(mode: Modes): void;
    private applyDroidStacking;
    private applyStandardStacking;
    private applyStandardOldStacking;
}
...
declare abstract class CircleSizeCalculator {
     ...
     */
    static standardScaleToDroidScale(scale: number, applyFudge?: boolean): number;
    /**
     ...
     */
    static standardCSToDroidScale(cs: number, applyFudge?: boolean): number;
}
 ...
 */
declare class ModDifficultyAdjust extends Mod implements IModApplicableToDroid, IModApplicableToOsu, IModApplicableToDifficultyWithSettings, IModApplicableToHitObjectWithSettings {
    readonly acronym = "DA";
    ...
    get isOsuRelevant(): boolean;
    get osuScoreMultiplier(): number;
    applyToDifficultyWithSettings(_: Modes, difficulty: BeatmapDifficulty, mods: ModMap): void;
    applyToHitObjectWithSettings(_: Modes, hitObject: HitObject, mods: ModMap): void;
    protected serializeSettings(): Record<string, unknown> | null;
...
declare class ModOldNightCore extends ModNightCore {
    readonly trackRateMultiplier = 1.39;
    calculateDroidScoreMultiplier(): number;
}
 ...
 */
declare class ModReallyEasy extends Mod implements IModApplicableToDroid, IModApplicableToDifficultyWithSettings {
    readonly acronym = "RE";
