...
class CircleSizeCalculator {
    ...
    static standardRadiusToDroidScale(radius) {
        return Math.max(1e-3, (radius * ((this.assumedDroidHeight * 0.85) / 384)) /
     ...
     */
    static standardScaleToDroidScale(scale, applyFudge = false) {
...
class Beatmap {
    ...
    createPlayableBeatmap(mods, mode) {
        ...
        mods.forEach((mod) => {
            if (mod.isApplicableToDifficultyWithSettings()) {
                mod.applyToDifficultyWithSettings(mode, converted.difficulty, mods);
            }
        });
