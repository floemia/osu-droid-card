    ...
    handleOptions(options) {
        ...
        if (this.difficultyAttributes.aimDifficultSliderCount > 0) {
            ...
            if (this.usingClassicSliderAccuracy) {
                ...
                estimateImproperlyFollowedDifficultSliders = osuBase.MathUtils.clamp(Math.min(this.totalImperfectHits, maxCombo - combo), 0, this.difficultyAttributes.aimDifficultSliderCount);
            }
            else {
                ...
                estimateImproperlyFollowedDifficultSliders = osuBase.MathUtils.clamp(this.sliderEndsDropped + this.sliderTicksMissed, 0, this.difficultyAttributes.aimDifficultSliderCount);
            }
